...
export const WorkerModal = ({ isOpen, setIsOpen }) => {
  ...
  const handleFormSubmit = async e => {
    ...
    setLoading(true)
    try {
      await Axios.post('/worker-name/create', birckData)
      mutate('/worker-name')
      setIsOpen(false)
    } catch (err) {
  ...
  return (
    ...
    >
      ...
      >
        <h2 className='text-2xl font-bold mb-6 text-center'>Янги Ишчи</h2>
